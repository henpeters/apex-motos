...
export const autoSeedIfEmpty = async (): Promise<void> => {
  try {
    ...
    console.log('[Seed] Database is empty. Running automatic seed sequence...');
    ...
    console.log(`[Seed] Created Admin User: ${adminUser.email} / admin123`);
    ...
    console.log(`[Seed] Created ${Object.keys(categoriesMap).length} Categories.`);
    ...
    const testimonialsData = [
      {
        ...
        rating: 5,
        comment: 'Apex Motors is hands down the best automotive shop I have ever used. They installed my Brembo GT-R brake kit and dialed in the KW coilover suspension perfectly.',
        active: true,
      },
      {
        ...
        rating: 5,
        comment: 'Fast shipping, genuine OEM parts, and incredible customer support. Ordering through their online store was seamless.',
        active: true,
      },
      {
        ...
        rating: 5,
        comment: 'Took my Mustang in for a full diagnostic scan and clutch replacement. The technicians are true craftsmen who treat your vehicle with extreme respect.',
        active: true,
      },
    ];
    ...
    console.log('[Seed] Created Testimonials.');
    ...
    console.log('[Seed] Created Hero Slides.');
